...
# [GCC 10.2.1 20210110]
# Embedded file name: /home/cagatay/PycharmProjects/ExpDateDetection/FCOS/fcos_core/modeling/rpn/fcos.py
# Compiled at: 2021-12-17 01:35:52
# Size of source mod 2**32: 7393 bytes
...
class FCOSModule(torch.nn.Module):
    ...
    def forward(self, images, features, targets=None):
        """
        Arguments:
            images (ImageList): images_det for which we want to compute the predictions
            features (list[Tensor]): features computed from the images_det that are
