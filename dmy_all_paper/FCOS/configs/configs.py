...
# [GCC 10.2.1 20210110]
# Embedded file name: /home/cagatay/PycharmProjects/ExpDateDetection/FCOS/configs/configs.py
# Compiled at: 2022-02-14 08:47:36
...
def fcos_cfgs(path):
    ...
    parser.add_argument('--images_det-dir',
      default=('{}/images_det/'.format(path)),
      metavar='DIR',
      help='path to demo images_det directory')
    ...
    print(f"Using {cfg.MODEL.DEVICE}...")
    cfg.freeze()
    return (
     args, cfg)
# okay decompiling ./configs.pyc
